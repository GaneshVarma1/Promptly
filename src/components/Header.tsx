...
const Header: FC = () => {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-white/10 bg-white/10 dark:bg-black/10 backdrop-blur-xl supports-[backdrop-filter]:bg-white/5 dark:supports-[backdrop-filter]:bg-black/5">
          ...
          {!isSignedIn ? (
            <div className="flex items-center space-x-1 sm:space-x-1.5 md:space-x-2">
              ...
              <SignUpButton mode="modal">
                <Button 
                  size="sm"
                  className="text-xs sm:text-sm px-2 sm:px-2.5 md:px-3 py-1.5 sm:py-2 bg-sky-600 hover:bg-sky-700 text-white backdrop-blur-sm shadow-lg h-8 sm:h-9"
                >
